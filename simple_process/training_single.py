...
ACTIVE_MODELS = ["NVP", "RectifiedFlow", "Autoregressive","GAN", "VAE"]
models_dict = {
    "VAE": ConditionalVAE(),
    "GAN": ConditionalGAN(),
...
def train_model(model, dataloader, epochs, device):
    """
    Training pipeline iterating over batches and executing unified model train steps.
...
if __name__ == "__main__":
    ...
    for name in ACTIVE_MODELS:
        if name in models_dict:
            ...
            save_path = f"models/weights/cache/{name.lower()}_base.pth"
